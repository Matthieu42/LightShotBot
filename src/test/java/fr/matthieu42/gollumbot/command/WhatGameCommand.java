...
public class WhatGameCommand extends Command {
    ...
    public void execute(MessageReceivedEvent event) {
        ...
        try {
            String games2 = new String(Files.readAllBytes(Paths.get("ressources/games2.txt")));
            String games3 = new String(Files.readAllBytes(Paths.get("./ressources/games3.txt")));
            String games4 = new String(Files.readAllBytes(Paths.get("./ressources/games4.txt")));
            String games5 = new String(Files.readAllBytes(Paths.get("./ressources/games5.txt")));
